# UnrealClaude Plugin Changes (Claude / Codex / MCPOnly)

This document explains the UnrealClaude (`UnrealClaude-Win64-v1.4.0`) changes and how to use the new modes.
...
- `EUnrealClaudeProviderMode`: `Claude` / `Codex` / `MCPOnly`
