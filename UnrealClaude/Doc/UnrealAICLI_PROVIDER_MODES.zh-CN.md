# UnrealAICLI 插件改造说明（Claude / Codex / MCPOnly）

本文档说明本次对 `UnrealAICLI-Win64-v1.4.0` 的改造内容，以及如何在项目中使用。
...
- `EUnrealAICLIProviderMode` 枚举：`Claude` / `Codex` / `MCPOnly`
