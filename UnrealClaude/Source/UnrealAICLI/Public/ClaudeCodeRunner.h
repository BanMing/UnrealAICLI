...
enum class EUnrealAICLIProviderMode : uint8
{
	Claude,
	Codex,
	MCPOnly
 ...
 */
class UNREALAICLI_API FClaudeCodeRunner : public IClaudeRunner, public FRunnable
{
public:
	FClaudeCodeRunner();
	...
	static EUnrealAICLIProviderMode GetProviderMode();
...
private:
	...
	void ExecuteProcess();
	void CleanupHandles();
	static FString GetProviderPath(EUnrealAICLIProviderMode Provider);
	static FString GetProviderLabel(EUnrealAICLIProviderMode Provider);
	static FString GetProviderExecutableName(EUnrealAICLIProviderMode Provider);
	static FString GetProviderInstallHint(EUnrealAICLIProviderMode Provider);
	static FString GetProviderLoginHint(EUnrealAICLIProviderMode Provider);
