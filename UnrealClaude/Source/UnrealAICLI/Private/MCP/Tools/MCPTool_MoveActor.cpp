...
FMCPToolResult FMCPTool_MoveActor::Execute(const TSharedRef<FJsonObject>& Params)
{
	...
	ResultData->SetObjectField(TEXT("location"), UnrealAICLIJsonUtils::VectorToJson(Actor->GetActorLocation()));
	ResultData->SetObjectField(TEXT("rotation"), UnrealAICLIJsonUtils::RotatorToJson(Actor->GetActorRotation()));
	ResultData->SetObjectField(TEXT("scale"), UnrealAICLIJsonUtils::VectorToJson(Actor->GetActorScale3D()));
