...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.SearchAllInGame",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.SearchWithClassFilter",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.SearchWithNamePattern",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.Pagination",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.LimitBounds",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.NonExistentPath",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetDependencies.NonExistentAsset",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetDependencies.IncludeSoftReferences",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetDependencies.PathValidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetReferencers.NonExistentAsset",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetReferencers.PathValidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.ResponseFormat",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.Assets.ToolAnnotationsCorrect",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.Tools.AssetSearch.ClassNameResolution",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
