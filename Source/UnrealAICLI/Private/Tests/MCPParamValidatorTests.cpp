...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.ActorName.ValidNames",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.ActorName.InvalidNames",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.ActorName.LengthLimits",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.ConsoleCommand.BlockedCommands",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.ConsoleCommand.ChainAttempts",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.ConsoleCommand.ValidCommands",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.BlueprintPath.Security",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.PropertyPath.Format",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.NumericValue.EdgeCases",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.SanitizeString.RemovesDangerousChars",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.MCP.ParamValidator.BlueprintNames.Validation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
