...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.GetScreenshotDirectory.ReturnsValidPath",
...
bool FClipboardImage_GetScreenshotDirectory_ReturnsValidPath::RunTest(const FString& Parameters)
{
	...
	TestTrue("Should contain UnrealAICLI", Dir.Contains(TEXT("UnrealAICLI")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.Cleanup.DeletesOldFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Cleanup_DeletesOldFiles::RunTest(const FString& Parameters)
{
	...
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealAICLI"), TEXT("test_screenshots"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.Cleanup.IgnoresNonClipboardFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_Cleanup_IgnoresNonClipboardFiles::RunTest(const FString& Parameters)
{
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealAICLI"), TEXT("test_screenshots2"));
	IFileManager::Get().MakeDirectory(*TestDir, true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.Cleanup.HandlesNonExistentDirectory",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.Constants.ReasonableValues",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Constants_ReasonableValues::RunTest(const FString& Parameters)
{
	TestTrue("MaxScreenshotAgeSeconds should be positive",
		UnrealAICLIConstants::ClipboardImage::MaxScreenshotAgeSeconds > 0.0);

	TestTrue("MaxScreenshotAgeSeconds should be at least 60 seconds",
		UnrealAICLIConstants::ClipboardImage::MaxScreenshotAgeSeconds >= 60.0);

	TestTrue("ThumbnailSize should be positive",
		UnrealAICLIConstants::ClipboardImage::ThumbnailSize > 0.0f);

	TestTrue("ThumbnailSize should be reasonable (16-256px)",
		UnrealAICLIConstants::ClipboardImage::ThumbnailSize >= 16.0f &&
		UnrealAICLIConstants::ClipboardImage::ThumbnailSize <= 256.0f);

	TestTrue("ScreenshotSubdirectory should not be null",
		UnrealAICLIConstants::ClipboardImage::ScreenshotSubdirectory != nullptr);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.DataStructs.RequestConfigHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.DataStructs.PromptOptionsHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.DataStructs.ConvenienceConstructorPreservesDefaults",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.PathValidation.ScreenshotDirIsUnderSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.ClipboardHasImage.DoesNotCrash",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.ParseResultMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.FallbackToAssistantBlocks",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.HandleEmptyOutput",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.HandleMalformedJson",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.BuildPayloadWithImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.BuildPayloadRejectsInvalidPath",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.BuildPayloadWithoutImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.BuildPayloadRejectsTraversal",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.BuildPayloadRejectsOversizedImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.StreamJson.ParseFailureReturnsErrorMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.BuildPayloadWithMultipleImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.BuildPayloadRespectsMaxCount",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_MultiImage_BuildPayloadRespectsMaxCount::RunTest(const FString& Parameters)
{
	...
	TestEqual("Should have 6 content blocks (1 text + 5 images, capped)",
		BlockCount, 1 + UnrealAICLIConstants::ClipboardImage::MaxImagesPerMessage);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.BuildPayloadSkipsInvalidImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.BuildPayloadTotalSizeGuard",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.BuildPayloadMixedValidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.ConstantsMaxImagesReasonable",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.RequestConfigArrayOperations",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAICLI.ClipboardImage.MultiImage.PromptOptionsArrayCopied",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
