	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAICLI, Log, TEXT("Added variable '%s' to Blueprint '%s'"),
	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAICLI, Log, TEXT("Removed variable '%s' from Blueprint '%s'"),
		*VariableName, *Blueprint->GetName());
	return true;
}
	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAICLI, Log, TEXT("Added function '%s' to Blueprint '%s'"),
	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAICLI, Log, TEXT("Removed function '%s' from Blueprint '%s'"),
		*FunctionName, *Blueprint->GetName());
	return true;
}
