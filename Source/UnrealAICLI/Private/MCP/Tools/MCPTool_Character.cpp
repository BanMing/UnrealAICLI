...
TSharedPtr<FJsonObject> FMCPTool_Character::CharacterToJson(ACharacter* Character, bool bIncludeMovement)
{
	...
	// Transform
	Json->SetObjectField(TEXT("location"), UnrealAICLIJsonUtils::VectorToJson(Character->GetActorLocation()));
	Json->SetObjectField(TEXT("rotation"), UnrealAICLIJsonUtils::RotatorToJson(Character->GetActorRotation()));
...
TSharedPtr<FJsonObject> FMCPTool_Character::MovementComponentToJson(UCharacterMovementComponent* Movement)
{
	...
	Json->SetObjectField(TEXT("velocity"), UnrealAICLIJsonUtils::VectorToJson(Movement->Velocity));
...
TSharedPtr<FJsonObject> FMCPTool_Character::ComponentToJson(UActorComponent* Component)
{
	...
	if (USceneComponent* SceneComp = Cast<USceneComponent>(Component))
	{
		...
		Json->SetObjectField(TEXT("relative_location"), UnrealAICLIJsonUtils::VectorToJson(SceneComp->GetRelativeLocation()));
		Json->SetObjectField(TEXT("relative_rotation"), UnrealAICLIJsonUtils::RotatorToJson(SceneComp->GetRelativeRotation()));
